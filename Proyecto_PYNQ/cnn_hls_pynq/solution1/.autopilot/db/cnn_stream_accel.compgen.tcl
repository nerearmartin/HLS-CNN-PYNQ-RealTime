...
set ID 117
set hasByteEnable 0
set MemName cnn_stream_accel_pad_img0
...
set ID 118
set hasByteEnable 0
set MemName cnn_stream_accel_img_buffer
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 32
set AddrRange 784
...
set ID 119
set hasByteEnable 0
set MemName cnn_stream_accel_output_buffer
set CoreName ap_simcore_mem
set PortList { 2 1 }
set DataWd 32
set AddrRange 10
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 120 \
			corename cnn_stream_accel_CTRL_axilite \
			name cnn_stream_accel_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
			is_flushable 0 \ 
			is_datawidth64 0 \ 
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cnn_stream_accel_CTRL_s_axi
}
...
# RegSlice definition:
set ID 135
set RegSliceName cnn_stream_accel_regslice_both
set RegSliceInstName cnn_stream_accel_regslice_both_U
set CoreName ap_simcore_cnn_stream_accel_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
