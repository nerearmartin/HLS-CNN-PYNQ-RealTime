...
extern "C" void cnn_stream_accel(__cosim_sC__*, __cosim_sC__*);
extern "C" void apatb_cnn_stream_accel_hw(volatile void * __xlx_apatb_param_in_stream, volatile void * __xlx_apatb_param_out_stream) {
  ...
  vector<__cosim_sC__> __xlx_in_stream_tmp_vec;
  while (!((hls::stream<__cosim_sC__>*)__xlx_apatb_param_in_stream)->empty() && __xlx_in_stream_V_tmp_Count < __xlx_in_stream_V_read_Size) {
    __xlx_in_stream_tmp_vec.push_back(((hls::stream<__cosim_sC__>*)__xlx_apatb_param_in_stream)->read());
    __xlx_in_stream_V_tmp_Count++;
  }
  ap_apatb_in_stream_V_cap_bc = __xlx_in_stream_tmp_vec.size();
  // store input buffer
  __cosim_sC__* __xlx_in_stream_input_buffer= new __cosim_sC__[__xlx_in_stream_tmp_vec.size()];
  ...
  __cosim_sC__* __xlx_out_stream_input_buffer= new __cosim_sC__[ap_apatb_out_stream_V_cap_bc];
  // DUT call
  cnn_stream_accel(__xlx_in_stream_input_buffer, __xlx_out_stream_input_buffer);
  for (unsigned i = 0; i <ap_apatb_out_stream_V_cap_bc; ++i)
    ((hls::stream<__cosim_sC__>*)__xlx_apatb_param_out_stream)->write(__xlx_out_stream_input_buffer[i]);
}
