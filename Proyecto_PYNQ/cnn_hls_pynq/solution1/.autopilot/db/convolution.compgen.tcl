...
set id 1
set name cnn_stream_accel_fadd_32ns_32ns_32_5_full_dsp_1
...
set id 3
set name cnn_stream_accel_fmul_32ns_32ns_32_4_max_dsp_1
...
set id 5
set name cnn_stream_accel_fcmp_32ns_32ns_1_2_no_dsp_1
...
set id 6
set name cnn_stream_accel_mux_42_32_1_1
...
eval "cg_default_interface_gen_dc { \
    id 62 \
    name conv_to_pool_stream_V \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_conv_to_pool_stream_V \
    op interface \
    ports { conv_to_pool_stream_V_din { O 32 vector } conv_to_pool_stream_V_full_n { I 1 bit } conv_to_pool_stream_V_write { O 1 bit } } \
} "
}
