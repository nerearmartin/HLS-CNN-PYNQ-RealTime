; ModuleID = 'C:/Users/Usuario/AppData/Roaming/Xilinx/Vitis/cnn_hls_pynq/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_cnn_stream_accel_ir(%"class.hls::stream.5"* %in_stream, %"class.hls::stream.5"* %out_stream) local_unnamed_addr #0 {
entry:
  %in_stream_copy = alloca %"class.hls::stream.5", align 512
  %out_stream_copy = alloca %"class.hls::stream.5", align 512
  call fastcc void @copy_in(%"class.hls::stream.5"* %in_stream, %"class.hls::stream.5"* nonnull align 512 %in_stream_copy, %"class.hls::stream.5"* %out_stream, %"class.hls::stream.5"* nonnull align 512 %out_stream_copy)
  call void @apatb_cnn_stream_accel_hw(%"class.hls::stream.5"* %in_stream_copy, %"class.hls::stream.5"* %out_stream_copy)
  call fastcc void @copy_out(%"class.hls::stream.5"* %in_stream, %"class.hls::stream.5"* nonnull align 512 %in_stream_copy, %"class.hls::stream.5"* %out_stream, %"class.hls::stream.5"* nonnull align 512 %out_stream_copy)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%"class.hls::stream.5"*, %"class.hls::stream.5"* noalias align 512, %"class.hls::stream.5"*, %"class.hls::stream.5"* noalias align 512) unnamed_addr #1 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.5"(%"class.hls::stream.5"* align 512 %1, %"class.hls::stream.5"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.5"(%"class.hls::stream.5"* align 512 %3, %"class.hls::stream.5"* %2)
  ret void
}
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%"class.hls::stream.5"*, %"class.hls::stream.5"* noalias align 512, %"class.hls::stream.5"*, %"class.hls::stream.5"* noalias align 512) unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.5"(%"class.hls::stream.5"* %0, %"class.hls::stream.5"* align 512 %1)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream.5"(%"class.hls::stream.5"* %2, %"class.hls::stream.5"* align 512 %3)
  ret void
}

declare void @apatb_cnn_stream_accel_hw(%"class.hls::stream.5"*, %"class.hls::stream.5"*)

define void @cnn_stream_accel_hw_stub_wrapper(%"class.hls::stream.5"*, %"class.hls::stream.5"*) #6 {
entry:
  call void @copy_out(%"class.hls::stream.5"* null, %"class.hls::stream.5"* %0, %"class.hls::stream.5"* null, %"class.hls::stream.5"* %1)
  call void @cnn_stream_accel_hw_stub(%"class.hls::stream.5"* %0, %"class.hls::stream.5"* %1)
  call void @copy_in(%"class.hls::stream.5"* null, %"class.hls::stream.5"* %0, %"class.hls::stream.5"* null, %"class.hls::stream.5"* %1)
  ret void
}

declare void @cnn_stream_accel_hw_stub(%"class.hls::stream.5"*, %"class.hls::stream.5"*)
